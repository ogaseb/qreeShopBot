...
export const regexes = {
  ...
  ARGUMENTS: /\b(\w*GBA|NES|SNES|3DS|NEW3DS|DSI|ESHOP|NEW 3DS|NEO GEO\w*)\b|\b\w*[0-9].[0-9]MB|\w*[0-9].[0-9]GB|\w*[0-9].[0-9]KB\w*\b|(http|ftp|https):\/\/([\w_-]+(?:(?:\.[\w_-]+)+))([\w.,@?^=%&:/~+#-]*[\w@?^=%&/~+#-])?|\w+|"(?:\\"|[^"])+"|\'(?:\\'|[^'])+'|\S+/gi,
  TITLE: /"(?:\\"|[^"])+"|\'(?:\\'|[^'])+'/g,
  REGIONS: /\b\w*USA|JPN|EUR|GLOBAL|HACK\w*\b/gi,
  PLATFORMS: /\b\w*GBA|NES|SNES|3DS|NEW3DS|DSI|ESHOP|NEW 3DS|NEO GEO\w*\b/gi,
  SIZE: /\b\w*[0-9].[0-9]MB|\w*[0-9].[0-9]GB|\w*[0-9].[0-9]KB\w*\b/gi,
