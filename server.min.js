      ...
      for (const item of messages) {
        if (!!item.attachments.size) {
          const metaInformation = item.content
            .match(_helpers_helpers__WEBPACK_IMPORTED_MODULE_0__["regexes"].SCRAPER_TITLE)
...
/*!****************************!*\
  !*** ./helpers/helpers.js ***!
  \****************************/
/*! exports provided: parseDropboxLink, parseGDriveLink, createASCIIQrCode, limitlessFetchMessages, createEmbeddedAnswer, checkIfDM, regexes */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
  ...
  if (!Object(_helpers_helpers__WEBPACK_IMPORTED_MODULE_2__["checkIfDM"])(receivedMessage)) {
    if (
      ...
      if (primaryCommand === "upload") {
        return Object(_commands_index__WEBPACK_IMPORTED_MODULE_1__["handleGameUpload"])(messageArguments, receivedMessage);
      }
