...
function createEmbeddedAnswer(args, receivedMessage){
  const embeds = [];
...
function processCommand(receivedMessage) {
  ...
  if(primaryCommand === "help"){
    ...
    Object(_helpers_helpers__WEBPACK_IMPORTED_MODULE_1__["checkIfDM"])(receivedMessage) ? receivedMessage.channel.send(
