            ...
            if (rows.length === 0) {
              return await receivedMessage.channel.send(
                `I didn't find anything called \`${messageArguments[1].replace(
                  /^"(.*)"$/,
                  "$1"
                )}\` in my database. Please check <#582266411166990346> for it, if it's there please inform Uploaders/Mods/Bot Dev about adding it to the bot. If it's not there either request game on #qr-game-requests`
              );
            } else {
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        async function handleGameUpload(
          ...
          const titleIndex = messageArguments.findIndex(value =>
            _helpers_helpers__WEBPACK_IMPORTED_MODULE_0__["regexes"].TITLE.test(
              value
            )
          );
          if (titleIndex === -1) {
          ...
          const sizeIndex = messageArguments.findIndex(value =>
            _helpers_helpers__WEBPACK_IMPORTED_MODULE_0__["regexes"].SIZE.test(
              value
            )
          );
          if (sizeIndex === -1) {
          ...
          if (
            messageArguments[urlIndex].match(
              _helpers_helpers__WEBPACK_IMPORTED_MODULE_0__["regexes"].GDRIVE
            )
          ) {
            messageArguments[urlIndex] = Object(
          ...
          const obj = {
            ...
            qr_data: await Object(
              _helpers_helpers__WEBPACK_IMPORTED_MODULE_0__["createASCIIQrCode"]
            )(messageArguments[urlIndex]),
            ...
            if (message.content.toLowerCase() === "yes") {
              ...
              try {
                ...
                const QrCodesSubscription = Object(
                  _helpers_helpers__WEBPACK_IMPORTED_MODULE_0__["sendToQrGames"]
