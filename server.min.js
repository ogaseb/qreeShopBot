    ...
    if (rows.length) {
      ...
      collector.on("end", async collected => {
        ...
        const obj = {
          ...
          qr_data: url ? await Object(_helpers_helpers__WEBPACK_IMPORTED_MODULE_2__["createASCIIQrCode"])(url) : rows[0].qr_data,
          qr_image_url: url
            ? await Object(_helpers_helpers__WEBPACK_IMPORTED_MODULE_2__["createDataURLQrCode"])(url)
            : rows[0].qr_image_url,
...
async function handleGameUpload(
  ...
  try {
    ...
    const urlIndex = messageArguments.findIndex(value =>
      _helpers_helpers__WEBPACK_IMPORTED_MODULE_0__["regexes"].URL.test(value)
    );
...
async function updateSize() {
  ...
  for (const { id, qr_link, name, region } of rows) {
    try {
      const response = await axios__WEBPACK_IMPORTED_MODULE_7___default()(qr_link);
      if (response && response.status !== 404) {
        ...
        if (response.headers["content-length"]) {
          await Object(_db_db_qree__WEBPACK_IMPORTED_MODULE_3__["updateSizeArgument"])(
            id,
            prettysize__WEBPACK_IMPORTED_MODULE_6___default()(response.headers["content-length"], true)
          );
          console.log(
            prettysize__WEBPACK_IMPORTED_MODULE_6___default()(response.headers["content-length"], true),
            name,
        ...
        if (found_region && region === "N/A") {
          ...
          await Object(_db_db_qree__WEBPACK_IMPORTED_MODULE_3__["updateRegionArgument"])(id, found_region[0]);
        }
      }
    } catch (e) {
  ...
  if (!Object(_helpers_helpers__WEBPACK_IMPORTED_MODULE_2__["checkIfDM"])(receivedMessage)) {
    if (
      ...
      if (primaryCommand === "invoke") {
        return Object(_commands_index__WEBPACK_IMPORTED_MODULE_1__["changeInvokeCommand"])(
          messageArguments,
          receivedMessage,
          serverInvokers
        );
