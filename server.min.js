  ...
  try {
    ...
    if (rows.length) {
      ...
      collector.on("end", async collected => {
        ...
        const urlIndex = args.findIndex(value => _helpers_helpers__WEBPACK_IMPORTED_MODULE_2__["regexes"].URL.test(value));
        if (urlIndex === -1) {
          await receivedMessage.channel.send(
        ...
        const titleIndex = args.findIndex(value => _helpers_helpers__WEBPACK_IMPORTED_MODULE_2__["regexes"].TITLE.test(value));
        if (titleIndex === -1) {
          await receivedMessage.channel.send(
        ...
        const sizeIndex = args.findIndex(value => _helpers_helpers__WEBPACK_IMPORTED_MODULE_2__["regexes"].SIZE.test(value));
        if (sizeIndex === -1) {
          await receivedMessage.channel.send(
...
async function handleGameUpload(
  ...
  if (messageArguments[urlIndex].match(_helpers_helpers__WEBPACK_IMPORTED_MODULE_0__["regexes"].GDRIVE)) {
    ...
    messageArguments[urlIndex].slice(-1) === "0"
      ? (messageArguments[urlIndex] = Object(_helpers_helpers__WEBPACK_IMPORTED_MODULE_0__["parseDropboxLink"])(
  ...
  collector.on("collect", async message => {
    if (message.content.toLowerCase() === "yes") {
      ...
      try {
        ...
        const QrCodesSearchResults = Object(_helpers_helpers__WEBPACK_IMPORTED_MODULE_0__["createEmbeddedAnswer"])(
          rows,
          receivedMessage
        );
        await QrCodesSearchResults.build();
