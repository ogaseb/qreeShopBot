...
/* harmony import */ var _db_db_qree__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../db/db_qree */ "./db/db_qree.js");
...
/* harmony import */ var pg_escape__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! pg-escape */ "pg-escape");
/* harmony import */ var pg_escape__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(pg_escape__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var image_data_uri__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! image-data-uri */ "image-data-uri");
/* harmony import */ var image_data_uri__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(image_data_uri__WEBPACK_IMPORTED_MODULE_4__);
  ...
  try {
    ...
    if (rows.length) {
      ...
      collector.on("end", async collected => {
        ...
        const args = collectedArguments.join(" ").match(_helpers_helpers__WEBPACK_IMPORTED_MODULE_2__["regexes"].ARGUMENTS);

        let url, title, region,platform, size;
        const urlIndex = await args.findIndex(value => _helpers_helpers__WEBPACK_IMPORTED_MODULE_2__["regexes"].URL.test(value));
        if (urlIndex === -1) {
          await receivedMessage.channel.send(
        ...
        const titleIndex = await args.findIndex(value =>
          _helpers_helpers__WEBPACK_IMPORTED_MODULE_2__["regexes"].TITLE.test(value)
        );
        if (titleIndex === -1) {
          await receivedMessage.channel.send(
        ...
        const regionIndex = await args.findIndex(value =>
          _helpers_helpers__WEBPACK_IMPORTED_MODULE_2__["regexes"].REGIONS.test(value)
        );
        if (regionIndex === -1) {
          await receivedMessage.channel.send(
        ...
        const platformIndex = await args.findIndex(value =>
          _helpers_helpers__WEBPACK_IMPORTED_MODULE_2__["regexes"].PLATFORMS.test(value)
        );
        if (platformIndex === -1) {
          await receivedMessage.channel.send(
        ...
        const sizeIndex = await args.findIndex(value =>
          _helpers_helpers__WEBPACK_IMPORTED_MODULE_2__["regexes"].SIZE.test(value)
        );
        if (sizeIndex === -1) {
          await receivedMessage.channel.send(
        ...
        const obj = {
          ...
          qr_data: url
            ? await Object(_helpers_helpers__WEBPACK_IMPORTED_MODULE_2__["createASCIIQrCode"])(url)
            : rows[0].qr_data,
          qr_image_url: url ? await Object(_helpers_helpers__WEBPACK_IMPORTED_MODULE_2__["createDataURLQrCode"])(url) :rows[0].qr_image_url,
        ...
        obj.name = pg_escape__WEBPACK_IMPORTED_MODULE_3___default.a
          ...
          .replace(/'/g, "''");
        await Object(_db_db_qree__WEBPACK_IMPORTED_MODULE_0__["editQree"])(
          id,
          obj.qr_data,
          obj.qr_image_url,
          obj.qr_link,
...
/* harmony import */ var _db_db_qree__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../db/db_qree */ "./db/db_qree.js");
  ...
  try {
    ...
    for (const {
      ...
      const obj = {
        ...
        qr_link: qr_link,
        qr_data: qr_data,
        qr_image: await Object(_helpers_helpers__WEBPACK_IMPORTED_MODULE_0__["createDataURLQrCode"])(qr_link),
        platform: platform,
        region: region,
        size: size,
        uploader_discord_id,
      ...
      if (qr_image_url === "null") {
        ...
        string = string.replace(/[^a-z0-9]/gim, "").replace(/\s+/g, "");
        // console.log(string);
        await image_data_uri__WEBPACK_IMPORTED_MODULE_3___default.a.outputFile(obj.qr_image, "./img/" + string + ".png");

        fs__WEBPACK_IMPORTED_MODULE_4___default.a.access("./img/" + string + ".png", fs__WEBPACK_IMPORTED_MODULE_4___default.a.F_OK, async err => {
          if (err) {
            console.error(err);
            return;
          }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _scrap_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./scrap.js */ "./commands/scrap.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "scrapChannelForQrCodes", function() { return _scrap_js__WEBPACK_IMPORTED_MODULE_0__["scrapChannelForQrCodes"]; });

/* harmony import */ var _invoke_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./invoke.js */ "./commands/invoke.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "changeInvokeCommand", function() { return _invoke_js__WEBPACK_IMPORTED_MODULE_1__["changeInvokeCommand"]; });

/* harmony import */ var _upload_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./upload.js */ "./commands/upload.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "handleGameUpload", function() { return _upload_js__WEBPACK_IMPORTED_MODULE_2__["handleGameUpload"]; });

/* harmony import */ var _search_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./search.js */ "./commands/search.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "searchGame", function() { return _search_js__WEBPACK_IMPORTED_MODULE_3__["searchGame"]; });

/* harmony import */ var _edit_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./edit.js */ "./commands/edit.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "handleGameEdit", function() { return _edit_js__WEBPACK_IMPORTED_MODULE_4__["handleGameEdit"]; });

/* harmony import */ var _help_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./help.js */ "./commands/help.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "createEmbeddedHelper", function() { return _help_js__WEBPACK_IMPORTED_MODULE_5__["createEmbeddedHelper"]; });

/* harmony import */ var _images__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./images */ "./commands/images.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "makeQrImagesfromDB", function() { return _images__WEBPACK_IMPORTED_MODULE_6__["makeQrImagesfromDB"]; });
...
function changeInvokeCommand(messageArguments, receivedMessage, serverInvokers) {
...
/* harmony import */ var _db_db_qree__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../db/db_qree */ "./db/db_qree.js");
/* harmony import */ var pg_escape__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! pg-escape */ "pg-escape");
/* harmony import */ var pg_escape__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(pg_escape__WEBPACK_IMPORTED_MODULE_5__);
...
/* harmony import */ var pg_escape__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! pg-escape */ "pg-escape");
/* harmony import */ var pg_escape__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(pg_escape__WEBPACK_IMPORTED_MODULE_2__);
...
async function searchGame(messageArguments, receivedMessage) {
  try {
    ...
    const name = pg_escape__WEBPACK_IMPORTED_MODULE_2___default.a
      ...
      .replace(/'/g, "''");
    const { rows } = await Object(_db_db_qree__WEBPACK_IMPORTED_MODULE_0__["findGame"])(name);
    if (rows.length === 0) {
...
async function handleGameUpload(
  ...
  try {
    ...
    const urlIndex = messageArguments.findIndex(value => _helpers_helpers__WEBPACK_IMPORTED_MODULE_0__["regexes"].URL.test(value));
    ...
    const titleIndex = messageArguments.findIndex(value =>
      _helpers_helpers__WEBPACK_IMPORTED_MODULE_0__["regexes"].TITLE.test(value)
    );
    if (titleIndex === -1) {
      return receivedMessage.channel.send(
    ...
    if (url.match(_helpers_helpers__WEBPACK_IMPORTED_MODULE_0__["regexes"].GDRIVE)) {
      url = Object(_helpers_helpers__WEBPACK_IMPORTED_MODULE_0__["parseGDriveLink"])(url);
    } else if (url.match(_helpers_helpers__WEBPACK_IMPORTED_MODULE_0__["regexes"].DROPBOX)) {
      if (
        url.slice(-1) === "0" ||
        url.slice(-1) === "1"
      ) {
        url = Object(_helpers_helpers__WEBPACK_IMPORTED_MODULE_0__["parseDropboxLink"])(url);
        url = url.match(
          /^(.*?)\.?dl=1/gi
        );
      }
    ...
    const obj = {
      ...
      qr_link: url[0],
      qr_data: await Object(_helpers_helpers__WEBPACK_IMPORTED_MODULE_0__["createASCIIQrCode"])(url),
      qr_image_url: await Object(_helpers_helpers__WEBPACK_IMPORTED_MODULE_0__["createDataURLQrCode"])(url),
      platform: platform,
      region: region,
      size: size,
      uploader_discord_id: receivedMessage.author.id,
    ...
    string = string.replace(/[^a-z0-9]/gim, "").replace(/\s+/g, "");
    await image_data_uri__WEBPACK_IMPORTED_MODULE_3___default.a.outputFile(obj.qr_image_url, "./img/" + string + ".png");

    const { rows } = await Object(_db_db_qree__WEBPACK_IMPORTED_MODULE_1__["findGame"])(obj.name.replace(/'/g, "''"));
    const text =
      rows.length === 0
        ? "```diff\n" +
        "+ This is how it will look, save in database? Type 'yes'/'no'" +
    ...
    collector.on("collect", async message => {
      if (message.content.toLowerCase() === "yes") {
        ...
        try {
          await receivedMessage.channel.send("Saving in database!");
          await Object(_db_db_qree__WEBPACK_IMPORTED_MODULE_1__["createQree"])(
            obj.qr_data,
            obj.qr_image_url,
            obj.qr_link,
            obj.name,
          ...
          const QrCodesSubscription = Object(_helpers_helpers__WEBPACK_IMPORTED_MODULE_0__["sendToQrGames"])(obj, receivedMessage, client);
          await QrCodesSubscription.build();
        } catch (e) {
          console.log(e);
          await receivedMessage.channel.send(
...
/*!***********************!*\
  !*** ./db/db_qree.js ***!
  \***********************/
/*! exports provided: createQree, editQree, findGame, findGameToEdit, approxQrCount, getWholeDB, updateQrImageUrl */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var url_status_code__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! url-status-code */ "url-status-code");
/* harmony import */ var url_status_code__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(url_status_code__WEBPACK_IMPORTED_MODULE_4__);
...
/* harmony import */ var prettysize__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! prettysize */ "prettysize");
/* harmony import */ var prettysize__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(prettysize__WEBPACK_IMPORTED_MODULE_6__);
...
async function createEmbeddedAnswer(args, receivedMessage, destination) {
  const embeds = [];
  args.map(
    async (
      {
...
async function urlStatus(client) {
  ...
  const { rows } = await Object(_db_db_qree__WEBPACK_IMPORTED_MODULE_3__["getWholeDB"])();
  for (const {
    id,
    qr_link,
    name,
  } of rows) {
    url_status_code__WEBPACK_IMPORTED_MODULE_4___default()(qr_link, async (error, statusCode) => {
      if (error) {
      } else {
        if (statusCode === 404) {
          await client.channels
...
async function updateSize(client) {
  ...
  {
    await request__WEBPACK_IMPORTED_MODULE_5___default()({
      url: qr_link,
      method: "HEAD"
    }, function(err, response) {
      if (response && size !== "N/A"){
        console.log(prettysize__WEBPACK_IMPORTED_MODULE_6___default()(response.headers["content-length"], true), name, id);
      }
    });
  }
}
...
/* harmony import */ var discord_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! discord.js */ "discord.js");
/* harmony import */ var discord_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(discord_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _commands_index__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./commands/index */ "./commands/index.js");
/* harmony import */ var _helpers_helpers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./helpers/helpers */ "./helpers/helpers.js");
/* harmony import */ var _models_database__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./models/database */ "./models/database.js");
/* harmony import */ var _db_db_qree__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./db/db_qree */ "./db/db_qree.js");
/* harmony import */ var request__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! request */ "request");
/* harmony import */ var request__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(request__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var prettysize__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! prettysize */ "prettysize");
...
void (async function() {
  try {
    await Object(_models_database__WEBPACK_IMPORTED_MODULE_3__["initializeDb"])();
...
client.on("ready", async () => {
  ...
  setInterval(async () => {
    const qrCount = await Object(_db_db_qree__WEBPACK_IMPORTED_MODULE_4__["approxQrCount"])();
  ...
  setInterval(async () => {
    await Object(_helpers_helpers__WEBPACK_IMPORTED_MODULE_2__["urlStatus"])(client);
  }, 1000 * 60 * 60);
...
function processCommand(receivedMessage) {
  ...
  Object(_helpers_helpers__WEBPACK_IMPORTED_MODULE_2__["checkIfDM"])(receivedMessage)
  ...
  const messageArguments = fullCommand.match(_helpers_helpers__WEBPACK_IMPORTED_MODULE_2__["regexes"].ARGUMENTS);
  ...
  if (primaryCommand === "help") {
    return Object(_commands_index__WEBPACK_IMPORTED_MODULE_1__["createEmbeddedHelper"])(serverInvokers, receivedMessage).build();
  }

  if (primaryCommand === "search") {
    return Object(_commands_index__WEBPACK_IMPORTED_MODULE_1__["searchGame"])(messageArguments, receivedMessage);
  }
  ...
  if (!Object(_helpers_helpers__WEBPACK_IMPORTED_MODULE_2__["checkIfDM"])(receivedMessage)) {
    if (
      ...
      if (primaryCommand === "upload") {
        return Object(_commands_index__WEBPACK_IMPORTED_MODULE_1__["handleGameUpload"])(messageArguments, receivedMessage, client);
      }

      if (primaryCommand === "invoke") {
        return Object(_commands_index__WEBPACK_IMPORTED_MODULE_1__["changeInvokeCommand"])(messageArguments, receivedMessage, serverInvokers);
      }

      if (primaryCommand === "scrap") {
        return Object(_commands_index__WEBPACK_IMPORTED_MODULE_1__["scrapChannelForQrCodes"])(messageArguments, receivedMessage);
      }

      if (primaryCommand === "images") {
        return Object(_commands_index__WEBPACK_IMPORTED_MODULE_1__["makeQrImagesfromDB"])(messageArguments, receivedMessage);
      }

      if (primaryCommand === "edit") {
        return Object(_commands_index__WEBPACK_IMPORTED_MODULE_1__["handleGameEdit"])(messageArguments, receivedMessage);
      }

      if (primaryCommand === "checkurls") {
        return Object(_helpers_helpers__WEBPACK_IMPORTED_MODULE_2__["urlStatus"])(client);
      }

      if (primaryCommand === "updatesize") {
        return Object(_helpers_helpers__WEBPACK_IMPORTED_MODULE_2__["updateSize"])(client);
      }
    } else {
      return receivedMessage.channel.send(
