...
async function handleGameUpload(
  ...
  try {
    ...
    const obj = {
      ...
      qr_link: url,
      qr_data: await Object(_helpers_helpers__WEBPACK_IMPORTED_MODULE_0__["createASCIIQrCode"])(messageArguments[urlIndex]),
      qr_image_url: await Object(_helpers_helpers__WEBPACK_IMPORTED_MODULE_0__["createDataURLQrCode"])(messageArguments[urlIndex]),
      platform,
      region,
      size,
      uploader_discord_id: receivedMessage.author.id,
...
/*!****************************!*\
  !*** ./helpers/helpers.js ***!
  \****************************/
/*! exports provided: parseDropboxLink, parseGDriveLink, createASCIIQrCode, createDataURLQrCode, limitlessFetchMessages, createEmbeddedAnswer, sendToQrGames, urlStatus, checkIfDM, regexes */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
  ...
  if (!Object(_helpers_helpers__WEBPACK_IMPORTED_MODULE_2__["checkIfDM"])(receivedMessage)) {
    if (
      ...
      if (primaryCommand === "invoke") {
        return Object(_commands_index__WEBPACK_IMPORTED_MODULE_1__["changeInvokeCommand"])(messageArguments, receivedMessage);
      }
