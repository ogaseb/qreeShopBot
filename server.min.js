/******/ (function(modules) {
  ...
  !*** ./helpers/helpers.js ***!
  \****************************/
      /*! exports provided: parseDropboxLink, parseGDriveLink, createASCIIQrCode, createEmbeddedHelper, createEmbeddedAnswer, checkIfDM, regexes */
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        "use strict";
        __webpack_require__.r(__webpack_exports__);
        /* harmony export (binding) */ __webpack_require__.d(
        ...
        function createEmbeddedAnswer(args, receivedMessage, destination) {
          const embeds = [];
          args.map(
            ({ qr_data, qr_link, name, platform, region, size }, index) => {
              embeds.push(
                new discord_js__WEBPACK_IMPORTED_MODULE_1__["MessageEmbed"]()
  ...
  \*******************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _models_database__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
        ...
        void (async function() {
          try {
            await Object(
              _models_database__WEBPACK_IMPORTED_MODULE_2__["initializeDb"]
            )();
        ...
        client.on("ready", async () => {
          ...
          setInterval(async () => {
            const qrCount = await Object(
              _db_db_qree__WEBPACK_IMPORTED_MODULE_3__["approxQrCount"]
            )();
        ...
        function processCommand(receivedMessage) {
          ...
          Object(_helpers_helpers__WEBPACK_IMPORTED_MODULE_1__["checkIfDM"])(
            receivedMessage
          )
          ...
          const messageArguments = fullCommand.match(
            _helpers_helpers__WEBPACK_IMPORTED_MODULE_1__["regexes"].ARGUMENTS
          );
        ...
        async function handleGameUpload(messageArguments, receivedMessage) {
          ...
          if (
            messageArguments[1].match(
              _helpers_helpers__WEBPACK_IMPORTED_MODULE_1__["regexes"].GDRIVE
            )
          ) {
            link = Object(
              _helpers_helpers__WEBPACK_IMPORTED_MODULE_1__["parseGDriveLink"]
            )(messageArguments[1]);
          } else if (
            messageArguments[1].match(
              _helpers_helpers__WEBPACK_IMPORTED_MODULE_1__["regexes"].DROPBOX
            )
          ) {
          ...
          if (
            !messageArguments[4].match(
              _helpers_helpers__WEBPACK_IMPORTED_MODULE_1__["regexes"].REGIONS
            )
          ) {
            return receivedMessage.channel.send(
          ...
          if (
            link.match(
              _helpers_helpers__WEBPACK_IMPORTED_MODULE_1__["regexes"].URL
            )
          ) {
            const qr = Object(
              _helpers_helpers__WEBPACK_IMPORTED_MODULE_1__["createASCIIQrCode"]
            )(link);
            const name = messageArguments[2].replace(/^"(.*)"$/, "$1");

            const { rows } = await Object(
              _db_db_qree__WEBPACK_IMPORTED_MODULE_3__["findGame"]
            )(name);
            const text =
              rows.length === 0
                ? "```diff\n" +
            ...
            const collector = new discord_js__WEBPACK_IMPORTED_MODULE_0__[
              "MessageCollector"
            ](
              receivedMessage.channel,
            ...
            collector.on("collect", async message => {
              if (message.content === "yes") {
                try {
                  ...
                  await Object(
                    _db_db_qree__WEBPACK_IMPORTED_MODULE_3__["createQree"]
                  )(
                    qr,
                    link,
                    name,
                ...
                try {
                  ...
                  const QrCodesSearchResults = Object(
                    _helpers_helpers__WEBPACK_IMPORTED_MODULE_1__[
                      "createEmbeddedAnswer"
                    ]
