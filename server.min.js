  ...
  try {
    ...
    if (rows.length) {
      ...
      collector.on("end", async collected => {
        ...
        let name;
        if (args[titleIndex]) {
          name = pg_escape__WEBPACK_IMPORTED_MODULE_3___default.a
        ...
        const obj = {
          ...
          qr_data: args[urlIndex]
            ? await Object(_helpers_helpers__WEBPACK_IMPORTED_MODULE_2__["createASCIIQrCode"])(args[urlIndex])
            : rows[0].qr_data,
          qr_image_url: args[urlIndex]
            ? await Object(_helpers_helpers__WEBPACK_IMPORTED_MODULE_2__["createDataURLQrCode"])(args[urlIndex])
            : rows[0].qr_image_url,
  ...
  try {
    ...
    for (const {
      ...
      const obj = {
        ...
        qr_link: qr_link,
        qr_data: qr_data,
        qr_image_url: await Object(_helpers_helpers__WEBPACK_IMPORTED_MODULE_0__["createDataURLQrCode"])(qr_link),
        platform: platform,
        region: region,
        size: size,
        uploader_discord_id,
      ...
      fs__WEBPACK_IMPORTED_MODULE_4___default.a.access("./img/" + string + ".png", fs__WEBPACK_IMPORTED_MODULE_4___default.a.F_OK, async err => {
        ...
        obj.qr_image_url = msg.attachments.values().next().value.proxyURL;
        await Object(_db_db_qree__WEBPACK_IMPORTED_MODULE_1__["updateQrImageUrl"])(obj.id, obj.qr_image_url);
      });
    }
  } catch (e) {
    console.log(e);
    ...
    Object(_helpers_helpers__WEBPACK_IMPORTED_MODULE_0__["limitlessFetchMessages"])(receivedMessage.channel).then(async messages => {
      for (const item of messages) {
        if (!!item.attachments.size) {
          ...
          if (value) {
            if (
              value.result.match(_helpers_helpers__WEBPACK_IMPORTED_MODULE_0__["regexes"].DROPBOX) &&
              value.result.match(_helpers_helpers__WEBPACK_IMPORTED_MODULE_0__["regexes"].CIA)
            ) {
              value.result = Object(_helpers_helpers__WEBPACK_IMPORTED_MODULE_0__["parseDropboxLink"])(value.result);
...
async function handleGameUpload(
  ...
  if (messageArguments[urlIndex].match(_helpers_helpers__WEBPACK_IMPORTED_MODULE_0__["regexes"].GDRIVE)) {
    messageArguments[urlIndex] = Object(_helpers_helpers__WEBPACK_IMPORTED_MODULE_0__["parseGDriveLink"])(messageArguments[urlIndex]);
  } else if (messageArguments[urlIndex].match(_helpers_helpers__WEBPACK_IMPORTED_MODULE_0__["regexes"].DROPBOX)) {
    if (
      messageArguments[urlIndex].slice(-1) === "0" ||
      messageArguments[urlIndex].slice(-1) === "1"
    ) {
      messageArguments[urlIndex] = Object(_helpers_helpers__WEBPACK_IMPORTED_MODULE_0__["parseDropboxLink"])(messageArguments[urlIndex]);
...
/*!****************************!*\
  !*** ./helpers/helpers.js ***!
  \****************************/
/*! exports provided: parseDropboxLink, parseGDriveLink, createASCIIQrCode, createDataURLQrCode, limitlessFetchMessages, createEmbeddedAnswer, sendToQrGames, checkIfDM, regexes */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
